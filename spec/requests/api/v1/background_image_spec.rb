...
RSpec.describe 'Get background image for city' do
  it 'gets a background image showing the city' do
    ...
    expect(result[:data][:attributes][:image][:credit]).to have_key :description
    expect(result[:data][:attributes][:image][:credit][:description]).to be_a(String)
    expect(result[:data][:attributes][:image][:credit]).to have_key :description
    expect(result[:data][:attributes][:image][:credit][:credit]).to be_a(String)
  end
end